...
function() {
    ...
    function a(a) {
        ...
        if (this.ctx = this.el.getContext("2d"), this.log = this.options.log, delete this.options.log, !this.log || !this.log.length) throw "No log specified";
    ...
    a.prototype.setupWaveFns = function() {
        for (var a = -1,
        b = this.log.length; ++a < b;) this.log[a].waveFn = i.getFn(o, this.log[a].type, "sine")
    },
    ...
    a.prototype.updateDimensions = function() {
        ...
        this.waveWidth = b(this.options.logWidth, this.width),
    ...
    a.prototype.update = function(a) {
        ...
        for (this.clear(), this.ctx.save(), this.rotation > 0 && (this.ctx.translate(this.width / 2, this.height / 2), this.ctx.rotate(this.rotation), this.ctx.translate( - this.width / 2, -this.height / 2)); ++b < c;) {
            var d = this.log[b].timeModifier || 1;
            this.drawWave(a * d, this.log[b])
        }
        this.ctx.restore(),
        b = void 0,
        c = void 0
...
$(function() {
    var a = new Sinelog({
        ...
        width: function() {
            ...
            return 768 > a ? 3 * $("#log").parent().width() : 1.4 * $("#log").parent().width()
        },
        height: function() {
            return $("#log").parent().height()
        },
        logWidth: "100%",
        ease: "SineInOut",
        log: [{
        ...
        resizeEvent: function() {
            ...
            // a.addColorStop(1, "rgba(84, 119, 239, 0.9)"),
            a.addColorStop(0, "rgba(0, 0, 0, 0)"),
            a.addColorStop(0.5, "rgba(58, 216, 243, 0.9)"),
            a.addColorStop(1, "rgba(160, 44, 151, 0.9)");
            for (var b = -1,
            c = this.log.length; ++b < c;) this.log[b].strokeStyle = a;
            b = void 0,
            c = void 0,
            a = void 0
        }
...
$(function() {
    var a = new Sinelog({
        el: document.getElementById("log21"),
        speed: 5,
        width: function() {
            var a = $(document).width();
            return 768 > a ? 3 * $("#log").parent().width() : 1.4 * $("#log").parent().width()
...
$(function() {
    var a = new Sinelog({
        ...
        width: function() {
            var a = $(document).width();
            return 768 > a ? 3 * $("#log2").parent().width() : 1.4 * $("#log2").parent().width()
        },
        height: function() {
            return $("#log2").parent().height()
        },
        logWidth: "100%",
        ease: "SineInOut",
        log: [{
